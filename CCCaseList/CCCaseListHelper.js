...
//                console.log("response: "+JSON.stringify(response));
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords) {
        ...
        keys = ['Subject','Ticket Number','Date/Time Opened','Last Modified Date','Status','Created By','My Tracking Number'];
        fieldNames = ['Subject','CaseNumber','CreatedDate','LastModifiedDate','Status','My_Name__c','Customer_Reference_Number__c'];
...
/*
    doFormSubmission : function(component, event, helper) {
        var compEvent = component.getEvent("caseSearch");
        compEvent.setParams({
            formData: {
                listView: component.get('v.viewSelect'),
                searchStr: component.get('v.searchStr')
