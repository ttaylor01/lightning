({
    showMessage: function (component, event, helper) {
        ...
        if (counter >= 1) {
            ...
            if (params.type === "Toast" || params.type === "Spinner") isFull = false;
            ...
            // Show message
            if ((isFull) || (params.type === "Toast" || params.type === "Spinner")) {
                ...
                if (params.type === "Spinner") {
                    var spinnerWindow = component.find("spinnerWindow");
                    $A.util.addClass(spinnerWindow, "slds-show");
                    $A.util.removeClass(spinnerWindow, "slds-hide");
        ...
        if (counter <= 0) {
            var timer = window.setTimeout(
                $A.getCallback(function () {
                    ...
                    var spinner = component.find("msgSpinner");
