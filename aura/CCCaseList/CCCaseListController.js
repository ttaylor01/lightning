({
    ...
    sortRow : function(component, event, helper) {
        ...
        console.log("sortRow by: "+colEl.getAttribute('data-row'));
    ...
    doSearch : function(component, event, helper) {
        ...
        if(doSearch) {
            ...
            // call the helper function   
            helper.getCases(component, helper, page, recordToDisplay);
//            helper.doFormSubmission(component,event,helper);
        }
    },
...
//        helper.doFormSubmission(component,event,helper);
    ...
    onListItemClick: function(component,event,helper) {
         ...
         */
        /*
         * Will fire event for parent component to handle navigation
        var urlEvent = $A.get("e.force:navigateToURL");
        urlEvent.setParams({
            "url": "/cccasedetail?recordId="+component.get("v.selectedRecordId")
        });
        urlEvent.fire();
         */
        var compEvent = component.getEvent("goToTarget");
    ...
    doDownLoadCSV : function(component, event, helper) {
        ...
        if(navigator.msSaveBlob) {
            var filename = component.get('v.viewSelect') + 'Tickets.csv';
            ...
            hiddenElement.download = component.get('v.viewSelect') + 'Tickets.csv';  // CSV file Name* you can change it.[only name not .csv] 
