        ...
        $A.createComponent(
            ...
            function(newComp, status, errorMessage) {
                if (status === "SUCCESS") {
                    ...
                    console.log("CCPayerSupportDetail.showRelatedLists No response from server or client is offline.");
                    // Show offline error
                }
                else if (status === "ERROR") {
                    console.log("CCPayerSupportDetail.showRelatedLists Error: " + errorMessage);
                    // Show error message
                }
            }
        );
