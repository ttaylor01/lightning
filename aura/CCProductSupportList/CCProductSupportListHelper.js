({
    getCases : function(component, helper, page, recordToDisplay) {
        ...
        apexBridge.callApex({
            component: component,
            request: {
                controller: "CCCustomerSupportCaseList",
                method: "getCases",
                input: { 
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords) {
        ...
        keys = ['Product','Subject','Ticket Number','Date/Time Opened','Last Modified Date','Status'];
        fieldNames = ['Call_Reason__c','Subject','CaseNumber','CreatedDate','LastModifiedDate','Status'];
